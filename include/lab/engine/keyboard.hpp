/**
 * @module      lab::engine::keyboard
 * @brief       The keyboard module.
 * @author      Timothée Napoli
 * @license     WTFPL
 * @copyright   Timothée Napoli (c) 2016
 */
#ifndef _lab_engine_keyboard_hpp_
#define _lab_engine_keyboard_hpp_
...
/**
 * Module that handles the keyboard.
...
class keyboard : public module
{
  public:
    ...
    /**
     * Key modifiers applied to key events.
     */
    enum {
        mod_shift   = 0x0001,
        mod_control = 0x0002,
